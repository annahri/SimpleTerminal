 ...
 */
static char *font = "JetBrains Mono,JetBrains Mono Medium:style=Medium,Regular:pixelsize=12:antialias=true:autohint=true";
//static char *font = "Iosevka SS08,Iosevka SS08 Medium:style=Medium:pixelsize=14:antialias=true:autohint=true";
//static char *font = "Fira Code,Fira Code Retina:style=Retina,Regular:pixelsize=14:antialias=true:autohint=true";
